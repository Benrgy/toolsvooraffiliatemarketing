...
const contactSchema = z.object({
  ...
  email: z.string().trim().email({
    ...
    message: "E-mail mag maximaal 255 tekens bevatten"
  }),
  toolName: z.string().trim().min(1, {
    message: "Tool naam is verplicht"
  }).max(200, {
    message: "Tool naam mag maximaal 200 tekens bevatten"
  }),
  toolUrl: z.string().trim().url({
    message: "Ongeldig URL formaat"
  }).max(500, {
    message: "URL mag maximaal 500 tekens bevatten"
  }),
            ...
            <CardContent className="pt-6">
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormField control={form.control} name="toolName" render={({
                  field
                }) => <FormItem>
                  ...
                  <FormField control={form.control} name="toolUrl" render={({
                  field
                }) => <FormItem>
                  ...
                  field
                        ...
                        <FormControl>
                          <Textarea placeholder="Vertel ons kort waarom deze tool geweldig is voor affiliate marketers..." rows={4} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>} />

                  <Button type="submit" size="lg" className="w-full gradient-primary shadow-primary" disabled={form.formState.isSubmitting}>
