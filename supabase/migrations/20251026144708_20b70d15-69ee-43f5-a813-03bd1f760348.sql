-- Create admin role system for proper access control
...
-- 5. Create policy for admins to manage all roles
...
-- 6. Restrict access_codes to admins only
...
-- 7. For authors table: keep authenticated user access but create admin policies for management
